...
# Note: The golden reference file hap1_golden.bin can be generated by running
# the decoder test suite on the hap1.mov fixture and capturing the decoded
# frame 0 output. This provides byte-exact BC1 reference data for regression testing.
# The synthetic golden test in test_decoder.cpp provides the primary regression test.
